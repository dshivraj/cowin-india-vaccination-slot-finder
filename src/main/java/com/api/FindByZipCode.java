...
public class FindByZipCode {
	...
	public static void main(String[] args) {
		...
		centersListFind.add("400077");
		centersListFind.add("400607");
		centersListFind.add("400703");
		centersListFind.add("400708");
...
//										if ("COVAXIN".equalsIgnoreCase(session.get("vaccine").toString())) {
										...
										System.out.println("ZipCode" + centersListFind.get(centersListcnt));
